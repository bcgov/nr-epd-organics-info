...
export const DATA_LAYER_GROUPS: DataLayerGroup[] = [
  {
    ...
    layers: [
      ...
      },
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_WATER_MANAGEMENT.GW_AQUIFER_VULN_SW_INTRUSN_SP/ows',
      ...
      },
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_WATER_MANAGEMENT.GW_WATER_WELLS_WRBC_SVW/ows',
    ...
    layers: [
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_WATER_MANAGEMENT.WLS_WATER_RIGHTS_APPLICTNS_SV/ows',
        layers: 'pub:WHSE_WATER_MANAGEMENT.WLS_WATER_RIGHTS_APPLICTNS_SV',
        styles: '7261',
      },
      {
        name: 'Water Rights - Licences',
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_WATER_MANAGEMENT.WLS_WATER_RIGHTS_LICENCES_SV/ows',
  ...
  },
  {
    ...
    layers: [
      ...
      },
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_BASEMAPPING.BC_MAJOR_WATERSHEDS/ows',
      ...
      },
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_BASEMAPPING.FWA_NAMED_WATERSHEDS_POLY/ows',
  ...
  },
  {
    ...
    layers: [
      ...
      {
        name: 'FWA Wetlands',
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_BASEMAPPING.FWA_WETLANDS_POLY/ows',
        layers: 'pub:WHSE_BASEMAPPING.FWA_WETLANDS_POLY',
        styles: '708_709_710',
      },
      {
        name: 'FWA Linear Boundaries',
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_BASEMAPPING.FWA_LINEAR_BOUNDARIES_SP/ows',
    ...
    layers: [
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_WATER_MANAGEMENT.WLS_POD_LICENCE_SOURCES_SP/ows',
      ...
      },
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_WATER_MANAGEMENT.WLS_BC_POD_DRINKNG_SOURCES_SP/ows',
    ...
    layers: [
      {
        ...
        url: 'https://openmaps.gov.bc.ca/geo/pub/WHSE_WILDLIFE_MANAGEMENT.WCP_CRITICAL_HABITAT_SP/ows',
