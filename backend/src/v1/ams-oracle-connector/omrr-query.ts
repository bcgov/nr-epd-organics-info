export const OMRR_QUERY = `SELECT DISTINCT TO_NUMBER(AUTHORIZATIONOBJECT.AUTHORIZATIONNUMBER) AS "Authorization Number",
                           ...
                           Union
Select Distinct To_Number(REGISTRATION.REGAUTHORIZATIONNUMBER)                                                     As "Authorization Number",
                DECODE(AUTHORIZATIONTYPE.AUTHORIZATIONNAME, 'Organic Matter Recycling Regulation',
                       'Notification')                                                                             As "Authorization Type",
                Case
                    When Upper(CLIENT.DoingBusinessAs) Is Not Null Then (Case
                                                                             When Upper(CLIENT.DUP_FORMATTEDNAME) Is Not Null
                                                                                 Then Upper(CLIENT.DUP_FORMATTEDNAME)
                                                                        ...
                                                                        ' doing business as ' ||
                                                                        Upper(CLIENT.DoingBusinessAs)
                    Else NVL(Upper(CLIENT.DUP_FORMATTEDNAME), InitCap(CLIENT.FIRSTNAME) || ' ' ||
                                                              InitCap(CLIENT.LASTNAME)) End                        As "Regulated Party",
                Decode(REGISTRATION.STATE, 'Cancelled', 'Inactive', 'Expired', 'Inactive', 'Active',
                       'Active')                                                                                   As "Authorization Status",
                To_Date(CORRAL_GENERATED_VIEWS.REGISTRATION.REGISTRATIONDATE)                                      as "Effective/Issue Date",
                To_Date(CORRAL_GENERATED_VIEWS.REGISTRATION.AmendmentDate)                                         as "Last Amendment Date",
                ADDRESS_2.INLINEDISPLAY                                                                            As "Facility Location",
                REGISTRATION.LATITUDE                                                                              As "Latitude",
                -1.0000000 * (REGISTRATION.LONGITUDE)                                                              As "Longitude",
                NULL                                                                                               as "Waste Discharge Regulation",
                CORRAL_GENERATED_VIEWS.REGISTRATION.OMOPERATIONTYPE                                                as "Operation Type",
                CORRAL_GENERATED_VIEWS.REGISTRATION.OMLANDBASEDTYPEOFPRODUCTION                                    as "Material Land Applied",
                CORRAL_GENERATED_VIEWS.REGISTRATION.INTENDEDDATESLANDAPPLICATION                                   as "Intended Dates of Land Application",
                CORRAL_GENERATED_VIEWS.REGISTRATION.OMDESIGNCAPACITY                                               as "Facility Design Capacity (t/y)",
                CORRAL_GENERATED_VIEWS.REGISTRATION.OMCOMPOSTFACILITYPRODUCTTYPE                                   as "Type of Compost Produced",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.YARDWASTE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Yard Waste",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.BIOSOLIDS, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Biosolids",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.WHEY, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Whey",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.UNTREATUNPROCESSWOODRESIDUALS, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Untreated and Unprocessed Wood Residuals",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.POULTRYCARCASSES, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Poultry Carcasses",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.FISHWASTE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Fish Wastes",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.FOODWASTE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Food Waste",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.BREWERYWASTEWINERYWASTE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Brewary Waste/Wine Waste",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.ANIMALBEDDING, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Animal Bedding",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.DOMESTICSEPTICTANKSLUDGE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Domestic Septic Tank Sludge",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.HATCHERYWASTE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Hatchery Waste",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.MANURE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Manure",
                Decode(CORRAL_GENERATED_VIEWS.REGISTRATION.MILKPROCESSINGWASTE, 'Y', 'Yes', 'N',
                       'No')                                                                                       as "Milk Processing Waste"
                Decode (CORRAL_GENERATED_VIEWS.REGISTRATION.PlantMatterFromProcessingPlant, 'Y','Yes', 'N' , 'No') as "Plant Matter Derived From Processing Plants"
From CORRAL_GENERATED_VIEWS.REGISTRATION,
     CORRAL_GENERATED_VIEWS.REGISTRATION_2 r2,
